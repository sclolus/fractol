...
t_image_frame				*ft_get_image_frames(t_mlx_ptr connector
												, uint32_t nbr_frames);
...
void						ft_handler_mouse_motion_julia(int x, int y
													, void *param);
void						ft_handler_mouse_motion_newtown(int x, int y
													, void *param);
void						ft_handler_mouse_motion_beryl(int x, int y
													, void *param);
...
t_complexe					ft_multiply_complexe(t_complexe *z1
												, t_complexe *z2);
...
void						ft_call_cl(t_mlx_data *mlx_data
						, t_fractal_type fractal_type);
t_cl_execution_data			*ft_get_cl_execution_data(
						t_fractal_type fractal_type);
...
# define SCREENSHOT_FILENAME_HEADER "./screenshots/fractol_screenshot_"
