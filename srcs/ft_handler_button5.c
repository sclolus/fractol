...
/*   Updated: 2017/07/15 01:09:59 by sclolus          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_handler_button5(int x, int y, void *param)
{
	...
	c_x = x * ((ft_float_distance(fractal_data[fractal_type].c.max.real_part
								   , fractal_data[fractal_type].c.min.real_part)) / WINDOW_WIDTH) + fractal_data[fractal_type].c.min.real_part;
	c_y = y * ((ft_float_distance(fractal_data[fractal_type].c.max.imaginary_part
	...
	fractal_data[fractal_type].iteration_number += log2(fractal_data[fractal_type].iteration_number)/*  * log(fractal_data[fractal_type].iteration_number) */;
