...
/*   Updated: 2017/07/20 09:44:40 by sclolus          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_handler_mouse_motion_julia(int x, int y, void *param)
{
	...
	coefficient = (t_complexe){ft_double_distance(fractal_data[JULIA].c.min.real_part
												  , fractal_data[JULIA].c.max.real_part) / (3), ft_double_distance(fractal_data[JULIA].c.min.imaginary_part
		, fractal_data[JULIA].c.max.imaginary_part) / 2};
