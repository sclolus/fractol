...
static inline void	ft_set_multilia_kernel_arg(t_cl_execution_data *cl_data
									, t_fractal_data *fractal_data)
{
	...
	ret |= clSetKernelArg(cl_data->kernel, 7, sizeof(uint32_t)
						...
						, t_cl_execution_data *cl_data)
{
	...
	ft_set_multilia_kernel_arg(cl_data, fractal_data);
