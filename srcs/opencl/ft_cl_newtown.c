...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/07/20 09:33:36 by sclolus           #+#    #+#             */
/*   Updated: 2017/08/29 01:50:52 by sclolus          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static inline void	ft_set_newtown_kernel_arg(t_cl_execution_data *cl_data
				...
				, t_fractal_data *fractal_data, t_cl_execution_data *cl_data)
{
	...
	ft_set_newtown_kernel_arg(cl_data, fractal_data);
